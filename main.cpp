...
void DesenhaMesa() {
	...
	// Para por as figuras em 3d
    /*glPushMatrix();
    glColor3f(0.4, 0.2, 0.0);
    glTranslatef(0.0f, -0.6f, 0.0f);
    glScalef(1.5f, 0.2f, 1.5f); // aplica escala
    glutSolidCube(1.0f);
    glPopMatrix();*/
}
...
void Teclado(unsigned char key, int x, int y) {
    switch (key) {
        case 27: exit(0);
        case 'a': Braco.anguloZ += 5; break;
        case 'd': Braco.anguloZ -= 5; break;
        case 'w': Antebraco.anguloZ += 5; break;
        case 's': Antebraco.anguloZ -= 5; break;
        case 'q': Mao.abertura += 2; break;
        case 'e': Mao.abertura -= 2; break;
        case 'r':
            Braco.anguloZ = 0;
            Antebraco.anguloZ = 0;
            Mao.abertura = 20.0f;
